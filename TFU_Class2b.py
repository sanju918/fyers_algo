...
client_id = os.environ.get('FYERS_CLIENT_ID')  ## Client_id here refers to APP_ID of the created app
secret_key = os.environ.get('FYERS_SECRET_ID')  ## app_secret key which you got after creating the app
